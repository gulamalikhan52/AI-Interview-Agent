...
if not st.session_state.started:
    ...
    with col2:
        ...
        st.html(
            ...
            <p style="color:#94a3b8; line-height:1.6;">
                ...
                completed learning journey and technology stack.
            </p>
    ...
    if st.button(
        ...
        if not tech_stack:
            st.error(
                "Please enter at least one technology in the Technology Stack field."
            )
            st.stop()
        ...
        candidate = {
            ...
            # NEW: SEND TECHNOLOGY STACK TO BACKEND
        ...
        try:
            ...
            if response.status_code != 200:
                ...
                st.session_state.follow_up = bool(
                    data.get("follow_up", False)
                )

                first_question = clean_text(
                    data.get(
                        "reply",
                        ""
                    )
...
# ==========================================================
    ...
    st.html(
        ...
        <div class="question-card">
            ...
            <div class="question-label">
                {"Follow-up Question" if st.session_state.follow_up else "Interviewer Question"}
            </div>
    ...
    if st.button(
        ...
        try:
            ...
            st.session_state.follow_up = is_follow_up
...
# ==========================================================
    ...
    # Backend schema can use either the current
    # or legacy field names.
    ...
    with col2:
        ...
        if weaknesses:
            ...
            st.caption(
                "No knowledge gaps were returned."
            )
